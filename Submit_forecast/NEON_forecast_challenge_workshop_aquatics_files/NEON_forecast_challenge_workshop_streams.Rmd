---
title: "NEON forecast challengeworkshop streams"
...
# This R markdown document for EFI-NEON Forecasting Challenge
...
my_model_id <- 'StreamTemp_AirTemp'
...
RW_forecast %>% 
  ...
  geom_point(data = subset(targets, site_id %in% c('ARIK', 'BLDE',
                        ...
                        'LEWI', 'MART', 
                        'MAYF', 'MCDI',
                        'MCRA', 'OKSR') & variable == 'temperature' ),
             aes(x=datetime, y=observation, group = 'obs'), colour = 'black') +
